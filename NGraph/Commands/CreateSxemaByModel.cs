...
/// <summary>Менеджер структурных схем: выбор режима, отбор оборудования и предпросмотр группировки.</summary>
[UsedImplicitly]
[Transaction(TransactionMode.Manual)]
public class CreateSxemaByModel : ExternalCommand
{
    protected virtual SchemeGroupingMode InitialMode => SchemeGroupingMode.Spaces;
    ...
    private void ExecuteManager()
    {
        ...
        var viewModel = new NGraphCreateSxemaByModelViewModel(source.Elements, source.Parameters, iniDirectory, InitialMode);
        while (true)
        {
            var window = new NGraphCreateSxemaByModelView(viewModel);
